// Diese Datei ist obsolet — der Code wurde direkt in home_screen.dart integriert.
...
class _TaskPlannerSection extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_TaskPlannerSection> createState() =>
      _TaskPlannerSectionState();
}
